...
// Checks: TWO-ASSET RULE (assets named exactly module.json + rippers-hoplosphere.zip — a missing/mis-named
...
const REPO = 'RoscoeRackham/rippers-hoplosphere';
const ID = 'rippers-hoplosphere';
